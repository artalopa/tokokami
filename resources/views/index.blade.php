        ...
        <div class="container">
            <div class="row">
                <div class="col-12 mb-6">
                    ...
                    <h3 class="mb-4 nav-name">Products</h3>
                    ...
                    <div class="card card-product">
                        <div class="card-body">
                            ...
                            <div class="text-center position-relative ">
                                ...
                                <a href="#!"> <img src="assets/img/product-img-1.jpg"
                            ...
                            <h2 class="fs-6"><a href="#!"
                                    class="text-inherit text-dark  text-decoration-none">Haldiram's Sev
                                    Bhujia</a></h2>
                            <div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="mb-8 mb-xl-0">
                        ...
                        <p>Not satisfied with a product? Return it at the doorstep & get a refund within hours. No
                            questions asked
                            <a href="#" class="text-inherit text-dark  text-decoration-none fw-bold"
                                style="color:green !important ;">policy</a>.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row align-items-center me-5">
            <div class="col-md-6"><span class="small text-muted ">Copyright 2022 © eCommerce HTML
                    Template. All rights reserved. Powered by <a
                        href="https://freeetemplates.com/">freeetemplates</a>.</span></div>
